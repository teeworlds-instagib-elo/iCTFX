...
MACRO_CONFIG_INT(SvBotAmount, sv_bot_amount, 4, 0, 32, CFGFLAG_SERVER, "Amount of bots")
MACRO_CONFIG_INT(SvBotAimDistanceFalloff_hard, sv_bot_aim_distance_falloff_hard, 600, 1, 5000, CFGFLAG_SERVER, "Aim accuracy falloff over distance bots (HARD)")
MACRO_CONFIG_INT(SvBotAimDistanceFalloff_easy, sv_bot_aim_distance_falloff_easy, 90, 1, 5000, CFGFLAG_SERVER, "Aim accuracy falloff over distance bots (EASY)")
MACRO_CONFIG_INT(SvBotSpeed_hard, sv_bot_speed_hard, 16, 0, 500, CFGFLAG_SERVER, "Sets speed of bots (HARD)")
MACRO_CONFIG_INT(SvBotSpeed_easy, sv_bot_speed_easy, 9, 0, 500, CFGFLAG_SERVER, "Sets speed of bots (EASY)")
MACRO_CONFIG_INT(SvBotReactionTime_hard, sv_bot_reaction_time_hard, 5, 0, 40, CFGFLAG_SERVER, "Sets reaction time of bots (HARD)")
MACRO_CONFIG_INT(SvBotReactionTime_easy, sv_bot_reaction_time_easy, 12, 0, 40, CFGFLAG_SERVER, "Sets reaction time of bots (EASY)")
MACRO_CONFIG_INT(SvBotReactionTimeRandom_hard, sv_bot_reaction_time_random_hard, 1, 0, 15, CFGFLAG_SERVER, "Sets random offset of reaction time of bots (HARD)")
MACRO_CONFIG_INT(SvBotReactionTimeRandom_easy, sv_bot_reaction_time_random_easy, 4, 0, 15, CFGFLAG_SERVER, "Sets random offset of reaction time of bots (EASY)")
MACRO_CONFIG_INT(SvBotReloadTime, sv_bot_reload_time, 65, 0, 150, CFGFLAG_SERVER, "Sets reload time of bots")
MACRO_CONFIG_INT(SvBotAimRandom_hard, sv_bot_aim_random_hard, 6, 0, 100, CFGFLAG_SERVER, "Sets random offset of aim of bots (HARD)")
MACRO_CONFIG_INT(SvBotAimRandom_easy, sv_bot_aim_random_easy, 25, 0, 100, CFGFLAG_SERVER, "Sets random offset of aim of bots (EASY)")
MACRO_CONFIG_INT(SvBotAvoidAimCharge_hard, sv_bot_avoid_aim_charge_hard, 1, 0, 100, CFGFLAG_SERVER, "Sets amount of time a bot has to be in sight before bots avoid a shot (HARD)")
MACRO_CONFIG_INT(SvBotAvoidAimCharge_easy, sv_bot_avoid_aim_charge_easy, 15, 0, 100, CFGFLAG_SERVER, "Sets amount of time a bot has to be in sight before bots avoid a shot (EASY)")
MACRO_CONFIG_INT(SvBotChargeTime_hard, sv_bot_charge_time_hard, 3, 0, 100, CFGFLAG_SERVER, "Sets amount of time a player has to be in sight before bots shoot (HARD)")
MACRO_CONFIG_INT(SvBotChargeTime_easy, sv_bot_charge_time_easy, 12, 0, 100, CFGFLAG_SERVER, "Sets amount of time a player has to be in sight before bots shoot (EASY)")
...
MACRO_CONFIG_INT(SvSmoothTarget, sv_smooth_target, 1, 0, 1, CFGFLAG_SERVER, "Interpolates player aim with preinputs, disable if antiping mispredictions happen")
MACRO_CONFIG_INT(SvPredictionPing, sv_prediction_ping, 1, 0, 1, CFGFLAG_SERVER, "Shows players gameplay ping instead of network ping")
