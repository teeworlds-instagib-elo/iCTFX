...
// 			GameServer()->m_World[GameServer()->m_apPlayers[i]->GetLobby()].ReleaseHooked(i);
// 		}
// 	}
...
// 	GameServer()->m_World[pPlayer->GetLobby()].SwapClients(pPlayer->GetCID(), pTargetPlayer->GetCID());
