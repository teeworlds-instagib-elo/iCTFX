...
MACRO_CONFIG_STR(SvLobbyMap, sv_lobby_map, 128, "lobby", CFGFLAG_SERVER, "Map to use on the server as lobby 0")
...
MACRO_CONFIG_INT(SvDefaultLobby, sv_default_lobby, 1, 0, MAX_LOBBIES, CFGFLAG_SERVER, "default lobby players will join")
